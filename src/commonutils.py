...
def applyNoise(filename,deviationCoefficient=200):
    fs_rate, signal_original = wavfile.read(filename)
    ...
    return signal_original+np.random.normal(0,dev,signal_original.shape) # add 0-centered noise to the original signal
